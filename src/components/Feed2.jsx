import React, { useState } from 'react'
  ...
  return (
    <>
    <div className="posts">
      <div className="card1 flex justify-start items-center relative border-b-0 border-[#ffffff60] top-[75vh]">
        <img
        ...
        <img
          ...
          src="https://pbs.twimg.com/media/GvSHu3BWkAA_8TN?format=jpg&name=small"
          alt="Post"
        />
      </div>

      <div className="icons absolute top-[170vh] left-[0vw]">
